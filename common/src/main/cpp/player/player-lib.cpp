...
Java_com_dwayne_com_player_PlayerManager_getFFmpegVersion
...
Java_com_dwayne_com_player_PlayerManager_setSurfaceNative(JNIEnv *env, jclass type,
                                                             jobject surface) {
...
extern "C"
JNIEXPORT void JNICALL
Java_com_dwayne_com_player_PlayerManager_prepareNative(JNIEnv *env, jclass thiz,
...
extern "C"
JNIEXPORT void JNICALL
Java_com_dwayne_com_player_PlayerManager_startNative(JNIEnv *env, jclass type) {
    if (player) {
        player->start();
    }
}
...
extern "C"
JNIEXPORT void JNICALL
Java_com_dwayne_com_player_PlayerManager_stopNative(JNIEnv *env, jclass type) {
    // TODO
    if (player)
        player->stop();
...
extern "C"
JNIEXPORT void JNICALL
Java_com_dwayne_com_player_PlayerManager_restartNative(JNIEnv *env, jclass type) {
    // TODO
    if (player) {
        player->restart();
    }
...
extern "C"
JNIEXPORT void JNICALL
Java_com_dwayne_com_player_PlayerManager_releaseNative(JNIEnv *env, jclass type) {
    // TODO
    if (player)
        player->release();
}
...
Java_com_dwayne_com_player_PlayerManager_isPlayerNative(JNIEnv *env, jclass type) {
...
Java_com_dwayne_com_player_PlayerManager_native_1GetDuration(JNIEnv *env, jobject instance) {
...
extern "C"
JNIEXPORT void JNICALL
Java_com_dwayne_com_player_PlayerManager_native_1seek(JNIEnv *env, jobject instance,
                                                         jint progress) {
